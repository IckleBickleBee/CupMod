...
namespace CupMod.Entities
{
    public class EntityThrownCup : Entity, IProjectile
    {
        ...
        public float HorizontalImpactBreakChance = 0f;
        ...
        public override void Initialize(EntityProperties properties, ICoreAPI api, long InChunkIndex3d)
        {
            ...
            //string color = WatchedAttributes.GetString("color", "gray");
